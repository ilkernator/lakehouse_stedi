...
DropDuplicates_node1696769183758 = DynamicFrame.fromDF(
    DropFields_node1695066327195.toDF().dropDuplicates(),
    glueContext,
    "DropDuplicates_node1696769183758",
)

# Script generated for node S3 bucket
S3bucket_node3 = glueContext.write_dynamic_frame.from_options(
    frame=DropDuplicates_node1696769183758,
    connection_type="s3",
    format="json",
    connection_options={
        "path": "s3://aws-nanodegree-test-bucket/accelerometer/trusted/",
        "partitionKeys": [],
    },
